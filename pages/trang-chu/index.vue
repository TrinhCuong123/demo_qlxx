        ...
        <div class="span-col-1 bg-white rounded-lg w-full">
          <div style="display: flex; align-items: center;" class="m-4 pl-3">
            <svg width="45" height="38" viewBox="0 0 45 38" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.3">
                <ellipse cx="20.9129" cy="16.2532" rx="16.087" ry="16.1027" fill="#62825D" />
                <ellipse cx="2.41304" cy="2.56595" rx="2.41304" ry="2.4154" fill="#62825D" />
              </g>
              <path
              ...
              <path d="M28.1521 13.0327V29.1354" stroke="#62825D" stroke-width="2" stroke-linecap="round"
        ...
        <div class="flex items-center m-2">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="38" viewBox="0 0 24 24" fill="none">
              <path fill="#62825D" d="M1 11v10h5v-6h4v6h5V11L8 6z" />
              <path fill="#62825D" d="M10 3v1.97l7 5V11h2v2h-2v2h2v2h-2v4h6V3zm9 6h-2V7h2z" />
            </svg>
          </div>
...
const setChartDataPie = () => {
  ...
  return {
    ...
    datasets: [
      {
        data: [540, 325, 702],
        backgroundColor: ['#12372A', '#62825D', '#f0da67'],
        hoverBackgroundColor: ['#12372A', '#62825D', '#f0da67']
      }
    ]
  };
};
